...
export default function GymPage() {
  const { events, hasMore, loading, error: loadError, loadMore, refresh } = useHistory('gym-session');
  ...
  return (
    <main className={styles.page}>
      ...
      <button
        ...
        style={{ '--accent': 'var(--state)' } as React.CSSProperties}
      ...
      {sheetOpen && <GymSheet onLog={log} onClose={() => setSheetOpen(false)} />}
      {editing && (
        <EditEventSheet
          event={editing}
          nowIso={nowIso}
